...
%1. Задание модели в виде непрерывной передаточной функкции
b0 = 0.01;
b1 = 0;
b2 = 1;
a0 = 0.0015;
...
%3. Получние переходноых характеристик
    %Непрерывной системы
%W = tf(num, den);
%figure;
%step(W);
...
%   и определение устойчивости системы
    %Отображение колебательного годографа неперывной системы
%figure;
%nyquist(W);
%grid on;
